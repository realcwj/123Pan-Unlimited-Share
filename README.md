...
- ♻️ 【开发中】从 Telegram 等渠道自动爬取资源，添加到公共资源库中

- ☁️ 【排期中】数据库功能，存储 base64 编码的文件信息，借此可以生成短的“分享码”
...
- 分享的内容均存储在 [public/ok/](public/ok/) 文件夹中。
